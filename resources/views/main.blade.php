    ...
    <div class="layui-layout layui-layout-admin">
        ...
        <ul class="layui-nav layui-layout-right" lay-filter="layadmin-layout-right">
          ...
          <li class="layui-nav-item" lay-unselect>
            ...
            <dl class="layui-nav-child">
              <dd><a id='admin_info' data-id='{{Auth::user()->id}}'>基本资料</a></dd>
              <hr>
              <form action="{{ route('logout') }}" method="POST" id='logout'>
                {{ csrf_field() }}
                {{ method_field('DELETE') }}
                <dd style="text-align: center;" onclick="document:logout.submit();" ><a>退出</a></dd>
              </form>
            </dl>
          </li>
      ...
      <div class="layui-side layui-side-menu">
        <div class="layui-side-scroll">
          <div class="layui-logo" lay-href="{{ Route('console.index') }}">
            <span>layuiAdmin</span>
          </div>
          <ul class="layui-nav layui-nav-tree" lay-shrink="all" id="LAY-system-side-menu" lay-filter="layadmin-system-side-menu">
          @foreach(Auth::user()->getMenus() as $key => $rule)
            @if($rule['name'] == '主页'){
            <li data-name="home" class="layui-nav-item layui-nav-itemed">
              ...
              @if(isset($rule['children']))
                <dl class="layui-nav-child">
                  ...
                  <dd data-name="console" @if( $k == 0) class="layui-this" @endif>
              ...
              <li class="layui-nav-item ">
                ...
                <i class="layui-icon {{$rule['fonts']}}"></i>
                <cite>{{$rule['name']}}</cite>
                </a>
                @if(isset($rule['children']))
                  <dl class="layui-nav-child">
